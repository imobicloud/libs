...
function TabGroupManager(args) {
	...
	init(args.tabs, args.controller);
	 ...
	 * */
	function init(arrayTab, controller) {
		controller.cleanup = TGCleanup;
		controller.reload  = TGReload;
	...
	function TGReload(params) {
	  	var current = getCache(activeTab, -1);
		current.controller.reload(params);	
	}
